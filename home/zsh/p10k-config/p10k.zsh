# Generated by Powerlevel10k configuration wizard on 2023-02-18 at 19:36 +08.
...
() {
  ...
  typeset -g POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS=(
    ...
    # nix_shell               # nix shell (unused - can cause 50-200ms prompt lag)
    ...
    # ram                   # free RAM
    # swap                  # used swap
    # todo                    # todo items (unused)
    # timewarrior             # timewarrior tracking status (unused)
    # taskwarrior             # taskwarrior task count (unused)
